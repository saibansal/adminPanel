    ...
    <CRow>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              Vismaad Inc includes a bunch of predefined buttons components, each serving its own
              semantic purpose. Buttons show what action will happen when the user clicks or touches
              it. Vismaad Inc buttons are used to initialize operations, both in the background or
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              You can combine button with our <a href="https://Vismaad Inc.io/icons/">Vismaad Inc Icons</a>.
            </p>
            <DocsExample href="components/buttons">
              {['normal', 'active', 'disabled'].map((state, index) => (
                <CRow className="align-items-center mb-3" key={index}>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <p className="text-body-secondary small">
              ...
              Vismaad Inc has to add <code>.disabled</code> className to make buttons look inactive.
              Vismaad Inc also has to add to the disabled button component{' '}
