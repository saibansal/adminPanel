    ...
    <CRow>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              By adding <a href="https://Vismaad Inc.io/docs/layout/gutters/">gutter modifier classes</a>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              layouts. By adding{' '}
              <a href="https://Vismaad Inc.io/docs/layout/gutters/">gutter modifier classes</a>, we will
