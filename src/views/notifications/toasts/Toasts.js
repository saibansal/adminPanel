  ...
  const exampleToast = (
    <CToast>
      <CToastHeader closeButton>
        ...
        <strong className="me-auto">Vismaad Inc for React.js</strong>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              <a href="https://Vismaad Inc.io/docs/utilities/api">utilities</a>, or by adding your own
              markup. Here we&#39;ve created a simpler toast by removing the default{' '}
              <code>&lt;CToastHeader&gt;</code>, adding a custom hide icon from{' '}
              <a href="https://Vismaad Inc.io/icons/">Vismaad Inc Icons</a>, and using some{' '}
              <a href="https://Vismaad Inc.io/docs/utilities/flex">flexbox utilities</a> to adjust the
              layout.
            </p>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              <a href="https://Vismaad Inc.io/docs/utilities/colors">color</a> and{' '}
              <a href="https://Vismaad Inc.io/docs/utilities/background">background</a> utilities. Here
