    ...
    <CRow>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              help of <a href="https://Vismaad Inc.io/docs/utilities/flex/">flexbox utilities</a>.
            </p>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              Place Vismaad Inc&#39;s checkboxes and radios within list group items and customize as
              needed.
            </p>
